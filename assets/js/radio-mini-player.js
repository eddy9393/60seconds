...
.mini-radio-player{position:fixed;left:8px;right:8px;bottom:calc(var(--mobile-bottom-nav-height,86px) + env(safe-area-inset-bottom,0px) - 1px);z-index:115;border-radius:16px 16px 0 0;padding:8px 10px 6px;background:rgba(255,255,255,.075)!important;background-image:none!important;border:1px solid rgba(255,255,255,.16);border-bottom:0;box-shadow:inset 0 1px 0 rgba(255,255,255,.12),0 -10px 28px rgba(0,0,0,.18);backdrop-filter:blur(22px) saturate(1.18);-webkit-backdrop-filter:blur(22px) saturate(1.18);color:#f5f5f5;font-family:'Manrope',sans-serif}
.mini-radio-player::before{content:"";position:absolute;inset:0;border-radius:inherit;pointer-events:none;background:linear-gradient(180deg,rgba(255,255,255,.08),rgba(255,255,255,.015));z-index:-1}
...
.mini-radio-artist,.mini-radio-title{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 2px 12px rgba(0,0,0,.24)}
.mini-radio-artist{font-size:11px;color:rgba(245,245,245,.74)}
...
.mini-radio-btn{appearance:none;-webkit-appearance:none;min-height:32px;border-radius:999px;border:1px solid rgba(255,255,255,.16)!important;background:rgba(255,255,255,.07)!important;background-image:none!important;color:#f5f5f5!important;padding:0 10px;display:inline-flex;align-items:center;justify-content:center;gap:6px;font-size:12px;font-weight:600;cursor:pointer;box-shadow:inset 0 1px 0 rgba(255,255,255,.10),0 8px 20px rgba(0,0,0,.14);white-space:nowrap;text-decoration:none!important;font-family:'Manrope',sans-serif;line-height:1;flex:0 0 auto;backdrop-filter:blur(14px) saturate(1.12);-webkit-backdrop-filter:blur(14px) saturate(1.12);transition:transform .16s ease,border-color .16s ease,background-color .16s ease,box-shadow .16s ease,color .16s ease}
.mini-radio-btn:hover{transform:translateY(-1px);background:rgba(255,255,255,.095)!important;border-color:rgba(212,175,55,.42)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.13),0 10px 22px rgba(0,0,0,.18),0 0 18px rgba(212,175,55,.12)}
...
.mini-radio-btn.is-liked{border-color:rgba(212,175,55,.58)!important;background:rgba(255,255,255,.09)!important;color:#ffd76a!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.13),0 10px 22px rgba(0,0,0,.16),0 0 20px rgba(212,175,55,.14)}
.mini-radio-btn.is-liked span{color:#ffd76a!important}
.mini-radio-btn.is-liked .mini-player-icon{color:#ffd76a!important}
...
.mini-radio-volume-wrap{display:inline-flex;align-items:center;gap:7px;min-width:34px;flex:0 0 34px;padding:0 8px;height:32px;border-radius:999px;border:1px solid rgba(255,255,255,.16);background:rgba(255,255,255,.07);box-shadow:inset 0 1px 0 rgba(255,255,255,.10),0 8px 20px rgba(0,0,0,.14);margin-left:auto;overflow:hidden;transition:flex-basis .22s ease,min-width .22s ease,padding .22s ease,border-color .16s ease,background-color .16s ease;backdrop-filter:blur(14px) saturate(1.12);-webkit-backdrop-filter:blur(14px) saturate(1.12)}
.mini-radio-volume-wrap:hover,.mini-radio-player.volume-open .mini-radio-volume-wrap{background:rgba(255,255,255,.095);border-color:rgba(212,175,55,.40)}
...
.mini-radio-volume-wrap input[type=range]{width:100%;min-width:0;margin:0;accent-color:#d4af37;background:transparent!important;opacity:0;pointer-events:none;transition:opacity .18s ease}
.mini-radio-player.volume-open .mini-radio-volume-wrap input[type=range]{opacity:1;pointer-events:auto}
.mini-radio-time{font-size:10px;color:rgba(245,245,245,.66);white-space:nowrap;min-width:60px;text-align:right;flex:0 0 auto}
...
@media (min-width:901px){.has-mini-radio-player{padding-bottom:0 !important}.mini-radio-player{left:auto;right:24px;bottom:24px;width:min(430px,calc(100vw - 120px));border-radius:22px;border-bottom:1px solid rgba(255,255,255,.16);padding:14px 16px;box-shadow:inset 0 1px 0 rgba(255,255,255,.12),0 18px 36px rgba(0,0,0,.20)}.mini-radio-top{gap:4px;margin-bottom:10px}.mini-radio-title{font-size:15px}.mini-radio-artist{font-size:13px}.mini-radio-btn{min-height:40px;padding:0 14px;font-size:14px}.mini-radio-volume-wrap{height:40px}.mini-radio-player.volume-open .mini-radio-volume-wrap{min-width:124px;flex-basis:140px}.mini-radio-time{font-size:12px;min-width:72px}}`;
